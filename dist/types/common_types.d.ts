...
type TableColumnType = {
    [column_name: string]: TableColumnInterface;
};
...
interface SchemaWithPriorityInterface {
    priority: number;
    app_id: string;
    schema_file: string;
    schema_def: TableSchemaInterface;
}
interface MigrationMetadataInterface {
    columns: string[];
    indexes: string[];
    timestamp: string;
    schema: string;
}
interface SchemaMigratedColumnsAndIndexesInterface {
    all_created_columns: Set<string>;
    all_created_indexes: Set<string>;
}
interface EnvConfigInterface {
    [key: string]: string | number | boolean;
}
export { PermissionType, ModelConstructorType, SupportedDatasourceType, SchemaTemplateType, ColumnPositionType, InitialMigrationTemplateType, DeltaMigrationTemplateType, MigrationStatusType, TableColumnType, DatasourceConnectorOptionInterface, TableColumnInterface, TableIndexInterface, TableSchemaInterface, FibaseHandshakeRequestInterface, FibaseHandshakeResponseInterface, QueryFormatOptionInterface, SchemaWithPriorityInterface, MigrationMetadataInterface, SchemaMigratedColumnsAndIndexesInterface, MigrationLogEntryInterface, EnvConfigInterface };
