...
const schema_code_template = (values:SchemaTemplateType): string => {
const { 
...
const initial_migration_code_template = (values:InitialMigrationTemplateType):string => {
...
const delta_migration_code_template = (values:DeltaMigrationTemplateType): string => {
